  ...
  const handelCancel = async (asset) => {
    try {
      ...
      if (response.status === 200) {
        showToast("Asset cancelled successfully");
        refetch();
      } else {
  ...
  return (
    <Container>
      <div className="bg-white rounded-md shadow-md mt-8">
        <div className="flex flex-col items-center gap-4 md:flex-row border-t py-3 justify-between px-4">
          ...
          <div>
            <select
              ...
              id="stockStatus"
              className="px-4 py-[6px] border rounded-md focus:outline-none focus:ring-2 focus:ring-[#685DD8] focus:shadow-md focus:shadow-[#685DD8]"
            >
